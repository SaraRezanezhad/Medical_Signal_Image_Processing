%% Ali Khosravipour 99101502 - Mohamad Hosein Faramarzi 99104095 - Sara Rezanezhad 99101643
clc;
clear;
load("ECG_sig.mat");
...
for i = 1:length(ATRTIMED)  
    ...
    if arrhythmiaType == 1 
        normal_beats = [normal_beats, rPeak];  
    else  
        abnormal_beats(i).time = rPeak;  
        abnormal_beats(i).type = arrhythmiaLabels{arrhythmiaType + 1};  
    end  
end
%% Part 4
fs = 360; 
